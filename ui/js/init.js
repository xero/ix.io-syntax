	...
	$('body').each(function(i, block) {
		...
		button.on('click', function(){
	  	...
	  	theme.on('change', function() {
	  		$('html').removeClass().addClass(this.value.replace(/ /g, '-'));
	  	});
  	});
});
